...
switch( state )
{
	...
	#region atirar
		...
		if shootimer == 1
		{
			bulletinst = instance_create_depth( x + bulletxoff*face, y + bulletyoff, depth, obj_bossbullet);
		}
	...
	#region atirar 2
		...
		if shootimer == 1
		{
			bulletinst = instance_create_depth( x + bulletxoff*face, y + bulletyoff, depth, obj_bossbullet2);
		}
